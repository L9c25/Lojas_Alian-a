...
<footer id="container-footer">
    ...
    <section class="sections" id="section-endereco">
        ...
        <div id="sec-local">
            <iframe 
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d344.7592383921203!2d-44.99109191834424!3d-12.145947572053622!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x75f8aa0de29a3a7%3A0xea1d4bad9eff5f25!2sLojas%20Allian%C3%A7a!5e0!3m2!1spt-BR!2sbr!4v1700950001757!5m2!1spt-BR!2sbr" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade">
            </iframe>
        </div>
    </section>
    ...
    <div class="container-endereco-contato" id="container-endereco-contato">
        <section class="sections" id="section-endereco-responsive">
            <div id="sec-endereco">
                <h2>Endereço</h2>
                <p>Avenida Antônio Carlos Magalhães, 542 - Sandra Regina <br> Barreiras - BA <br>47802-000
                </p>
        ...
        <section class="sections" id="contato-responsivo">
            <div id="card1-contatos">
                <h3>Entre em contato</h3>
                <p>Redes Sociais</p>
                <div id="container-contato-svg">
    ...
    <section id="atendimento-responsivo">
        <div id="card1-atendimento">
            <h3>Formas de pagamento</h3>
            <div id="svg-formasPag"> 
                <img src="./components/footer/assets/elo.svg" alt="">
